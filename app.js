...
mongoose.connect(
  "mongodb+srv://venusalexandra:venusso1113@cluster0.j5ykmny.mongodb.net/todolistDB",
  {
...
app.get("/:customListName", function (req, res) {
  // Use lodash modedule _.capitalize to turn the custom list name into only first letter capitalised
...
app.post("/delete", function (req, res) {
  ...
  if (listName === "Today") {
    ...
    List.findOneAndUpdate(
      { name: listName },
      // Use $pull MongoDB operator to get the item out of the array
